...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { account_id: @friendship.account_id, create: @friendship.create, destroy: @friendship.destroy, friend_id: @friendship.friend_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { account_id: @friendship.account_id, create: @friendship.create, destroy: @friendship.destroy, friend_id: @friendship.friend_id } }
